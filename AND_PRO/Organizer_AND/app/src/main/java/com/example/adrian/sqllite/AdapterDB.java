...
public class AdapterDB {
    ...
    public boolean updateZadanie(Zadanie zadanie)
    {
        long id = zadanie.getId();
        String nazwa = zadanie.getNazwa();
        String telefon = zadanie.getTelefon();
        String data = zadanie.getData();
        String miejsce = zadanie.getMiejsce();
    ...
    public Zadanie getZadanie(long id)
    {
        String[] kolumny = {key_id, key_nazwa, key_telefon, key_data, key_miejsce};
        String where = key_id + "=" + id;
        ...
        if(cursor != null && cursor.moveToFirst())
        {
            ...
            zadanie = new Zadanie(id, nazwa, telefon, data, miejsce);
        }
        return zadanie;
    }
